    ...
    <div className="landing-page">
      ...
      <nav className="navbar">
        <div className="nav-content">
          <div className="logo">DevMaroc</div>
      ...
      <section className="hero" ref={heroRef}>
        ...
        <div className="hero-cta">
          <button className="btn btn-primary">Rejoindre la Communauté</button>
          <button className="btn btn-outline">Découvrir la Plateforme</button>
        </div>
